...
%\begin{enumerate}
%    \item The microphysical processes of ionization/recombination and heating/cooling occur on much smaller timescales and so can be assumed to be in equilibrium.
%    \item The secular evolution of the nebula expansion and the globule photoevaporation occur on much longer timescales, which allows the photoevaporation flow enough time to reach a steady-state configuration.
%\end{enumerate}
%This justifies the assumptions which we make in the model (section~\ref{Chapter : Modelo}). 
...
%In section~\ref{sec: distrtibucion} we consider two simple limiting cases for the velocity law: constant velocity, $v(r) = \SI{46}{km.s^{-1}}$, and velocity proportional to radius, 
