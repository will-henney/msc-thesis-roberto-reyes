...
Con estas densidades obtenidas para la parte neutra, tenemos masas en el rango de 1.17--\SI{10.05e-3}{\msun}. Estas estimaciones de masas son parecidas a lo que \cite{Grosdidier:1998} calcula para estos nodos, que son del orden de \SI{1e-4}{\msun}.
Aunque no podemos estimar la masa de todos los glóbulos debido a que algunos fueron descartados, como vimos en la sección \ref{Bad globules}, la masa total de los glóbulos está entre \SI{1e-1}{}--\SI{1}{\msun}, la cual es mucho menor que la masa fotoionizada de toda la nebulosa que estima \cite{Jimenez_H:2020}, que es de  $9.2_{-1.5}^{+1.6}\unit{\msun}$.
...
En la figura \ref{fig:ang_Will} vemos como nuestras mediciones (puntos rojos), obtenidos a partir de comparar la presión de la cáscara de los glóbulos con la presión exterior del viento concuerdan con la mediciones realizada a partir de espectros bidimensionales (puntos azules). Estas dos mediciones son totalmente independientes y podemos ver una clara anti correlación entre el ángulo de inclinación y la separación que observamos.

El grupo de glóbulos más cercanos a la estrellas parece estar a unos \SI{15}{\arcsecond} según la figura \ref{fig:zavala_nudos}, los cuales coinciden con nuestras mediciones que vemos en la figura \ref{fig:hist_sep_ryp}.
