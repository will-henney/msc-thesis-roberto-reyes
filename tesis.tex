...
\[\frac{I}{cgs}=\int \frac{f_{H\alpha}\alpha_\beta n_e n_p}{4\pi}dz\] donde $f_{H\alpha}$ es la fracción de fotones que pasan para poder ionizar el gas neutro, $\alpha_\beta$ el coeficiente de recombinación, $n_e$ la densidad eléctrica, $n_p$ la densidad de iones y todo esto se integra a lo largo de la línea de visión. Si consideramos como constantes tanto a la fracción de fotones como al coeficiente de recombinación a lo largo de la línea de visión entonces tenemos que
\[\frac{I}{cgs}=\frac{f_{H\alpha}\alpha_\beta}{4\pi}\int n_en_pdz=\frac{f_{H\alpha}\alpha_\beta}{4\pi} EM \approx \frac{\SI{1.17e-13}{}}{4\pi}EM.\]
Por otro lado para el brillo $B$ en las observaciones tenemos la siguiente conversión a unidades en cgs
\[\frac{B}{cgs}=(h\nu)_{H\alpha}0.0137\] por lo que podemos conocer la EM a partir de las observaciones como 
\[\frac{\frac{B}{cgs}}{\frac{I}{cgs}}=\frac{(h\nu)_{H\alpha}0.0137}{\frac{\SI{1.17e-13}{}}{4\pi}EM}\Rightarrow EM = \Big(\frac{I}{B}\Big)\frac{4\pi 0.0137}{\SI{1.17e-13}{}}\] como todo está en unidades cgs, entonces nuetra EM tendrá unidades de \SI{}{cm^{-5}}.
...
En \cite{Jimenez_H:2020} estiman una masa inicial de $\sim\SI{40}{\msun}$ para la estrella central en secuencia principal, por lo que un  límite superior para esta fuerza de gravedad por parte de la estrella nos da una aceleración de 
\[\frac{GM_*}{r^2}\approx \SI{2.79e-14}{km/s^2}\] con $r$ una distancia típica entre la estrella y el glóbulo de \SI{16.98}{\arcsecond}
...
\[\frac{G M_g}{r_1^2}\approx \SI{4.6e-16}{km/s^2}.\]

Es por esto que podemos despreciar las aceleraciones por parte de las fuerzas de gravedad tanto de la estrella como del mismo glóbulo.

\section{Presión de radiación}

Para la presión de radiación tenemos que $L = \SI{1.25e49}{s^{-1}}$ según la tabla \ref{tab:parametros WR-124}, por lo que tendríamos una intensidad de $\frac{L h\nu}{4\pi r^2} = \frac{\SI{3.78e30}{W}}{4\pi r^2} \approx \SI{1.58e-3}{W.m^{-2}}$ para la frecuencia de $H_\alpha$ a una distancia típica de los glóbulos. Por lo que tendríamos una presión de radiación de \[\frac{I}{c}\approx\SI{5.25e-12}{Pa}\] la cual es una presión menor a la presión RAM del viento estelar o a la presión de los glóbulos.
