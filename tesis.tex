...
Se encontraron 168 nudos glóbulos en la nebulosa M1-67 los cuales están distribuidos a una distancia de la estrella central de entre 3--\SI{35}{\arcsecond}, esta distancia puede ser en realidad una distancia proyectada para algunos glóbulos.  Estos glóbulos se pueden observar ya sea en grupos o solos como se puede ver en la figura \ref{fig:dis_nudos}. 

El ajuste de las dos gaussianas a los perfiles de brillo se realizó para las observaciones de HST en H$\alpha$  y para las observaciones con JWST se utilizó el filtro F090N. Este filtro podemos ver la emisión de gas neutro, polvo y algunos PAHs. 

Gracias a que tenemos las observaciones de dos telescopios podemos comparar los ajustes para saber si estos ajustes son buenos. Debido a que usamos diferentes filtros con diferentes resoluciones podemos comparar mejor si los ajustes son buenos o no, esto ya que con los diferentes filtros podemos ver diferentes morfologías y tener un mejor criterio si los radios calculados están sobrestimados o no, también si las observaciones están muy contaminadas por fuentes cercanas o la estructura de la gran nebulosa, también debemos considerar que la emisión puede ser contaminada por otros glóbulos como lo es en el caso de los glóbulos que se encuentran en grupo. 
...
\section{Corrección por proyección}
...
Si suponemos que el glóbulo está proyectado por un ángulo $i$ como vemos en la figura \ref{Ang proyeccion}, entonces tenemos que \[R\cos i=R_p\] donde $R$ es la separación real del glóbulo a la estrella, $i$ en ángulo de inclinación y $R_p$ la distancia proyecta, que es la que observamos. En esta proyección la presión RAM también se verá disminuida por un factor. Podemos considerar un factor promedio de $\cos{i}^{1/2}$.  Por lo que \[P_{RAM}=\frac{\dot{M}v_\infty}{4\pi R_p^2}\cos{i}^{5/2}\]
...
La corrección por ángulo en principio se puede aplicar solo a los glóbulos cuya presión de la cáscara  es menor que la presión RAM. En esta corrección no esperaos ver glóbulos con un ángulo de inclinación de $\pm 90^\circ$ ya que estos estarían totalmente de espaldas o de frente, en cualquier caso estos no los podríamos ver porque se verían afectados por la estrella WR ya que en proyección estarían muy cerca de la estrella. Esto último es algo que se pudo notar al momento de hacer los ajustes, por lo que aún si se les pudiera ver o detectar una cáscara chocada, la estimación de sus presiones y densidades estarían mal ya que pueden verse muy afectadas por la estrella.

Por otro lado se pueden apreciar glóbulo cuyas presiones de la cáscara chocada es mayor que la presión RAM. Esto se puede deber a que el viento estelar haya interactuado antes con glóbulos que están más cerca de la estrella. En la figura \ref{graf_presion_ang} vemos como esto se da en los glóbulos que están más alejado.
