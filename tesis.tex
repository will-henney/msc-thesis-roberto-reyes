...
El ajuste de las dos gaussianas a los perfiles de brillo se realizó para las observaciones de HST en H$\alpha$  y para el caso de las observaciones con el JWST usamos varios filtros, en el filtro F090N vemos principalmente la emisión de gas ionizado y  PAHs por lo que podemos dar un mejor criterio si es que en realidad hay una cáscara chocada. También se uso una combinación de los filtros F150W, F210m y F335M para ver la emisión de gas neutro quitando la emisión de las estrellas.
