...
\section{Estimación del radio de la parte neutra}

Si bien se realizó el ajuste de dos gaussianas a los perfiles de brillo con las observaciones de HST, con este solo podemos asegurar el tamaño de la cáscara chocada ya que solo vemos el gas ionizado. Por lo que para estar seguros en la medición de la parte neutro utilizamos una combinación de filtros.  En el filtro f335m encontramos emisión de gas neutro (PAHs) por lo que usamos este filtro y le quitamos la emisión de estrellas y del gas ionizado, para eso se uso una combinación lineal de los filtros f150w y f210m.

En esta estimación como solo veremos a emisión de gas neutro y difusa, solo vamos ajustar una gaussiana y una constante. Lo que se espera es que esta medición sea menor que la medición con el HST. 

A diferencia del método utilizado en la sección \ref{Sec: Ajuste de modelo} aquí vamos a trazar una línea perpendicular al eje de simetría y en esta línea perpendicular vamos a considerar un ángulo pequeño alrededor de el, mientras que para la parte central vamos a considerar un pequeño círculo para encontrar el centro de la parte neutra.
