...
\cite{Canto:1996} trata de una manera más detallada la interacción entre dos flujos hipersónicos en la cual considera dos fuentes separadas a una distancia $D$. En este análisis suponen que se forma una cáscara delgada cuando estos dos flujos llegan a un equilibrio de presiones como se puede ver en la Figura \ref{fig:Canto1}. En nuestro caso también esperamos que  la zona 2 de la Figura \ref{fig:zones} sea delgada \citep{Wil:2019}.
